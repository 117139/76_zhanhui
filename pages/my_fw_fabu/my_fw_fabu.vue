<template>
	<view class="minh100">
		<view class="box_box">
			...
			<view class="box_main">
				<view class="box_tit">服务标题</view>
				<input class="box_int" type="text" v-model="datas.title" placeholder="请输入服务标题">
				<view class="box_tit">服务价格</view>
				<view class="dis_flex aic ">
					<input class="box_int" type="digit" v-model="datas.price" placeholder="请输入金额"><text class="flex_0 box_int_dw" style="">元</text>
				</view>
